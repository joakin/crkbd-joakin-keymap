...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+---------------+--------------|  |--------+--------------+--------+--------+--------+--------|
                                  OSL(1), ALT_T(KC_BSPC), CTL_T(KC_ESC),     KC_SPC, OSM(MOD_LSFT), OSL(2)
                             //`---------------------------------------'  `--------------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------------+--------------|  |--------------+--------------+--------+--------+--------+--------|
                                 _______, OSM(MOD_LALT), OSM(MOD_LCTL),    OSM(MOD_LGUI), OSM(MOD_LSFT),   MO(3)
                             //`--------------------------------------'  `--------------------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------------+--------------|  |--------------+--------------+--------+--------+--------+--------|
                                   MO(3), OSM(MOD_LALT), OSM(MOD_LCTL),    OSM(MOD_LGUI), OSM(MOD_LSFT), _______
                             //`--------------------------------------'  `--------------------------------------'
  ),
